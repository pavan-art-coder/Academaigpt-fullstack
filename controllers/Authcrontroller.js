...
const cong = require('../config');

const JWT_SECRET=cong.jwtSecret
...
const login=async(req,res)=>{
    ...
    try{
        ...
        const Match=await bcryptjs.compare(password,Luser.password)
        if(!Match){
...
const googleSignIn = async (req, res) => {
    ...
    try {
        ...
        const appToken = jwt.sign({ id: user._id }, cong.jwtSecret, {
